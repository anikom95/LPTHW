...
if entrance == "1":
    ...
    if "bread" in choice:
        ...
        print "There is nothing like that on the table."
        exit(0)
    ...
    if way_in == "1":
        ...
        print "You find a small door to enter the castle and find yourself in a room leading to an old staircase or an elevator. Which one do you choose?"
